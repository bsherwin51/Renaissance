...
output_size        = 200 # size of SED/wavelength array
max_layers         = 3 # max number of hidden layers to test out
max_neurons_layers = 1000 # max number of nodes per hidden layer to test out
